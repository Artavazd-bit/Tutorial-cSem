...
\section{Adjusting the PLS Algorithm}
...
# show summary
summary_res_pls <- summarize(res_pls)
print(summary_res_pls)

summary_res_pls$Estimates$Loading_estimates
summary_res_pls$Estimates$Path_estimates
@
